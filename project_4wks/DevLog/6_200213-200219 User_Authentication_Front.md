...
7. mypage의 로그인,로그아웃, 비밀번호 관련기능을 완성해가고 followrList를 어떻게 해야할까 고민을 시작한 차에, 소켓부분의 server 코드에 고민이 많으셨던 성현님이 오피스아워에 *두현님* 께 프로젝트를 들고갔다가 *router*에 대하여 대차게 까이고 오셨다.. 두현님이 지적한 부분은 정말 당연하면서도 생각하지도 못했던 부분이였는데,..
